    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="p-8 space-y-10">
                ...
                <section x-data="{ isStockable: {{ old('is_stockable', $product->is_stockable) ? 'true' : 'false' }} }">
                    <div class="flex items-center gap-2 mb-6 border-b border-gray-100 pb-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500 text-sm">$</span>
                                <x-text-input type="number" step="0.01" name="cost" class="w-full pl-7" :value="old('cost', $product->cost)" />
                            </div>
                        </div>
