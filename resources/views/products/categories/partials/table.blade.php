        ...
        <tr class="hover:bg-gray-50 transition border-b border-gray-100">
            ...
            <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                    @php 
                        $isLastActives = $item->is_active && $categories->where('is_active', true)->count() <= 1; 
                    @endphp
                    ...
                    <button 
                        ...
                        {{ $isLastActives ? 'title=No_puedes_eliminar_una_categoria_activo_minimo' : '' }}>
...
@include('products.categories.partials.modals')
